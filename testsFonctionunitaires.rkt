...
(include "../exemples/ex5/exemple5.rkt")
(include "../exemples/OccurrencesNets/occurrenceNet2.rkt")
(include "../exemples/Homomorphismes/homomorphism.rkt")

(define gdm1 (unweighted-graph/directed '()))
(define n1 (rPn 1 P T F R M0 gdm1 1))
...
;-------------------------------------------------------------------
; Interface between unfolding and occurrence net (used in deplie.rkt)
...
;(define (homomorphism? h n1 n2)
;  (and (for/and ([p1 (rPn-P n1)]) (member (hash-ref h p1) (rPn-P n2)))
;       (for/and ([t (rPn-T n1)]) (member (hash-ref h t) (rPn-T n2)))
;       (for/and ([t (rPn-T n1)])
;         (for/and ([p2 (• (hash-ref h t) (rPn-F n1))])
;           (for/or ([pp1 (• t (rPn-F n1))]) ... to do
